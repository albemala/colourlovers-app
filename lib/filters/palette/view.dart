...
class PaletteFiltersViewCreator extends StatelessWidget {
  const PaletteFiltersViewCreator({super.key});
...
class PaletteFiltersView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarView(context, title: 'Filter Palettes'),
      body: BackgroundView(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _PaletteNameView(state: state, controller: controller),
    ...
    return Column(
      ...
      children: [
        ...
        SingleChildScrollView(
          ...
          child: Row(
            spacing: 8,
            children: ColorFilter.values.map((colorFilter) {
              return ChoiceChip(
...
class _PaletteNameView extends StatelessWidget {
  ...
  const _PaletteNameView({required this.state, required this.controller});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        TextFieldView(
          text: state.paletteName,
          onTextChanged: controller.setPaletteName,
        ),
      ],
    );
  }
